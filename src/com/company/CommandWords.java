...
public class CommandWords
{
    ...
    {
        if (aString.equals("save") || aString.equals("help") || aString.equals("see")){
            return false;
        }
    ...
    public void printUserCommands(){
        game.print("go, save, quit, help, take, drop, inventory, " +
                "see, use, give, talk, back, " +
                "examine, look around, exits");
    }

    public static String getUserCommands(){
        return "go, save, quit, help, take, drop, inventory, " +
                "see, use, give, talk, back, " +
                "examine, look around, exits";
    }
